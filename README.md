...
This repository describes the 18 Apiary Test API. The description from the master branch is automatically rendered into [API Documentation](http://docs.18apiarytest.apiary.dev).
...
If you want to develop a client for this API, head [to the documentation](http://docs.18apiarytest.apiary.dev) to get the address of the mock server (lives on `apiary-mock.com`) generated from this blueprint.
